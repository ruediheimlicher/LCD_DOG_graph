...
const char font_proportional_8px_data[] PROGMEM = {
...
const struct font_info font_proportional_8px PROGMEM = {0x58+(0x04<<8),0x08,0x08,0x20,0xFF,font_proportional_8px_data,(char*)font_proportional_8px_data+0xFF-0x20+1};
