...
const char %0:s_data[] PROGMEM = {
%12:s
};

const struct font_info %0:s PROGMEM = {0x%3:0.2x+(0x%2:0.2x<<8),0x%4:0.2x,0x%5:0.2x,0x%7:0.2x,0x%8:0.2x,%0:s_data,(char*)%0:s_data+0x%8:0.2x-0x%7:0.2x+1};
